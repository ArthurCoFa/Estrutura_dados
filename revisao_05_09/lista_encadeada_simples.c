...
/////////////////////////////////////////////////
// Funcao que insere um nó na lista pelo final //
/////////////////////////////////////////////////
...
struct no *inserir(struct no *cabeca, int numero){
    ...
    */
    ...
    novoNo -> proximo = NULL;
    // Faz com que o próximo do novo nó seja nulo. Pois vamos inserir no final da lista.
    // Se fosse inserir no começo da lista seria novoNo -> proximo = cabeca.

    // Cenário onde a cabeça está vazia, ou seja lista não tem nenhum elemento
    if (cabeca == NULL){
        return novoNo; // Retorna o novo nó que vai ser colocado e ele vira a cabeca.
    }

    // Cenário onde a lista não está vazia e vamos colocar no último
    struct no *ultimo = cabeca;
    // Cria um ponteiro que olha para onde a cabeça está
    while (ultimo -> proximo != NULL){
        ultimo = ultimo -> proximo;
        /*
        Se o proximo elemento onde esse ponteiro está não é nulo, então
        Ele vai andar para o próximo nó da lista até chegar no último nó.
        */
    }
    ultimo -> proximo = novoNo;
    // Percorremos a lista até chegar no último nó e colocamos o novo depois dele.
    return cabeca;
    // Retornamos a cabeca atualizada, pois o último endereço de memória foi atualizado.
}
